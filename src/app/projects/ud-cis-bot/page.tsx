...
const stack = ["Node.js", "MongoDB", "Discord.js", "Google OAuth"];
...
export const metadata: Metadata = {
  ...
  description:
    "Keeping 4,000+ UD CIS students informed directly inside Discord.",
};
      ...
      <main className='mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 pb-16 pt-20 sm:px-6'>
        <header className='detail-panel space-y-6 p-8'>
          ...
          <p className='text-base text-white/75'>
            Department-operated bot that sends class schedules, reminders, and
            quick actions to 4,000+ students.
          </p>
